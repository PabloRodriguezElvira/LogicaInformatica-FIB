...
void funcion(vector<int>& v, int j) {
    vector<pair<int, int>> vpairs;
    for (int i = 0; i < v.size(); ++i) {
        vpairs.push_back(make_pair(v[i], i+1));
    }
    sort(vpairs.begin(), vpairs.end(), cmp);
    cout << "assertz(nearestCities(" << j+1 << ", [";
    for (pair<int,int> p : vpairs) cout << p.second << ", ";
    cout << "]))," << endl;
}
...
int main () {
    ...
    vector<vector<int>> mat = {{105,181, 49, 0, 73,189, 31,124,152, 67, 52, 88,135,195,146,197,169,147,123, 40, 51, 49},
