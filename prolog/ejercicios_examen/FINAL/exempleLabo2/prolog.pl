...
assignColors([white|L]):- assignColors(L).

% nth1(N,L,E) means: "The N-th element of list L is E"
sameColorsInSomeEdge(L):- nth1(N1,L,Color), nth1(N2, L, Color), edge(N1, N2).

oddLengthCycle:- numNodes(N), between(1,N,Initial), camino(Initial, Initial , [], []),
	length(C,Len), 
	1 is mod(Len, 2),
